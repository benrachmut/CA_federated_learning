...
class Server(LearningEntity):
    ...
    def compute_with_server_KMeans_same_output_per_client_mean(self, mean_pseudo_labels_per_cluster,clusters_client_id_dict):
        ...
        pseudo_labels_list = list(pseudo_labels_for_model.values())
    ...
    def iteration_context(self,t):
        ...
        if experiment_config.with_server_net:
            ...
            if experiment_config.cluster_architecture == ClusterArchitecture.KMeans_same_output_per_cluster or \
                    experiment_config.cluster_architecture == ClusterArchitecture.KMeans_same_output_per_client_mean:
                self.compute_without_server_KMeans_same_output_per_cluster(self, mean_pseudo_labels_per_cluster,
    ...
    def get_mean_pseudo_labels(self):
        ...
        mean_per_cluster = {}
        clusters_client_id_dict = self.k_means_grouping(experiment_config.num_clusters)
